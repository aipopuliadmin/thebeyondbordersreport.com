 ...
 * Editorial style with top bar, branding, navigation, and actions
 *
...
<header class="modern-header header-magazine menu-position-<?php echo esc_attr( $menu_position ); ?><?php echo $enable_sticky ? ' header-sticky' : ''; ?>">
    
    <!-- Top Row: Logo & Social Icons -->
    <div class="magazine-top-row">
        <div class="magazine-top-wrapper">
            <!-- Brand Logo -->
        ...
        </div><!-- .magazine-top-wrapper -->
    </div><!-- .magazine-top-row -->
    
    <!-- Bottom Row: Navigation Menu & Search -->
    <div class="magazine-nav-row">
        <div class="magazine-nav-wrapper">
        ...
        </div><!-- .magazine-nav-wrapper -->
    </div><!-- .magazine-nav-row -->
