<?php
/**
 * Header Layout: Modern (from homepage-modern-layout.html)
 * Logo with icon, horizontal nav, search, theme toggle, subscribe button
 *
...
<header class="modern-header header-minimal menu-position-<?php echo esc_attr( $menu_position ); ?><?php echo $enable_sticky ? ' header-sticky' : ''; ?>">
