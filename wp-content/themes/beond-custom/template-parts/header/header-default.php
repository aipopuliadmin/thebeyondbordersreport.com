<?php
/**
 * Header Layout: Default (Modern from HTML design)
...
<header class="modern-header menu-position-<?php echo esc_attr( $menu_position ); ?><?php echo $enable_sticky ? ' header-sticky' : ''; ?>">
